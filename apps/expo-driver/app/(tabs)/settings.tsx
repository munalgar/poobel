...
import { usePoobelStore, useCurrentDriver } from '@poobel/shared-data';
import { Colors } from '../../constants/Colors';

export default function SettingsScreen() {
  const currentDriver = useCurrentDriver();
  const resetData = usePoobelStore((state) => state.resetData);
  const updateDriverStatus = usePoobelStore((state) => state.updateDriverStatus);
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.profileInfo}>
            <Text style={styles.profileName}>{currentDriver.name}</Text>
            <Text style={styles.profileEmail}>{currentDriver.email}</Text>
            <Text style={styles.profileVehicle}>{currentDriver.vehiclePlate}</Text>
          </View>
              ...
              <View style={styles.settingLeft}>
                ...
                <View>
                  ...
                  <Text style={styles.settingDescription}>
                    {isOnline ? 'You are visible to dispatch' : 'You are offline'}
                  </Text>
                </View>
              </View>
              <Switch
            ...
            <View style={styles.settingRow}>
              <View style={styles.settingLeft}>
                ...
                <View>
                  ...
                  <Text style={styles.settingDescription}>Route and dispatch alerts</Text>
                </View>
              </View>
              <Switch
                value={true}
          ...
          <View style={styles.settingCard}>
            <TouchableOpacity style={styles.settingRow}>
              <View style={styles.settingLeft}>
                ...
                <View>
                  <Text style={styles.settingLabel}>Default Navigation App</Text>
                  <Text style={styles.settingDescription}>Apple Maps</Text>
                </View>
              </View>
            ...
            <View style={styles.settingRow}>
              <View style={styles.settingLeft}>
                ...
                <View>
                  ...
                  <Text style={styles.settingDescription}>Open navigation on stop select</Text>
                </View>
              </View>
              <Switch
                value={false}
          ...
          <View style={styles.settingCard}>
            ...
            <TouchableOpacity style={styles.settingRow}>
              <View style={styles.settingLeft}>
                ...
                <Text style={styles.settingLabel}>Contact Dispatch</Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color={Colors.dark.textMuted} />
            </TouchableOpacity>
            <View style={styles.divider} />
          ...
          <View style={styles.settingCard}>
            <TouchableOpacity style={styles.settingRow} onPress={resetData}>
              <View style={styles.settingLeft}>
                ...
                <View>
                  <Text style={[styles.settingLabel, { color: Colors.danger }]}>Reset Demo Data</Text>
                  <Text style={styles.settingDescription}>Restore all mock data to initial state</Text>
                </View>
              </View>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.version}>
          <Text style={styles.versionText}>Poobel Driver v1.0.0</Text>
